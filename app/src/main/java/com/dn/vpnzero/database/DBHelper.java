package com.dn.vpnzero.database;
...
public class DBHelper  extends SQLiteOpenHelper {
    ...
    public void putLine(String line, int type) {
        ...
        if (data.length == 15) {
            ...
            ContentValues contentValues = new ContentValues();
            Util.log("IP: "+data[1]);
            Util.log("Country name: "+data[5]);
            Util.log("Host name: "+data[0]);
            Util.log("==========================");
    ...
    public ArrayList<Server> getUniqueCountries() {
        ArrayList<Server> countryList = new ArrayList<Server>();
        SQLiteDatabase db = this.getWritableDatabase();
